...
//test
const salad = createMenuItem('Salad', 3.75, 'Sides')
//test function

/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */
const grilledCheese = createMenuItem('Grilled Cheese', 3, 'Lunch')
const blt = createMenuItem('BLT', 4, 'Lunch')
const rootbeerFloat = createMenuItem('Rootbeer Float', 3, 'Dessert')
...
burger.discount = function(str) {
  if(str === 'teacher' || str === 'student') return this.price*.75
  else if(str === 'public') return this.price*.9
}
//test
